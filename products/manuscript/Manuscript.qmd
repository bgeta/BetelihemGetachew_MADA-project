...
#| fig-cap: "HSI By Age."
#| echo: FALSE
knitr::include_graphics(here("results","figure1.png"))
```

@figure2 shows a boxplot showing HSI Group mean age of smoking initiation

```{r}
#| label: figure2
#| fig-cap: "HSI By Age of smoking Initiation."
#| echo: FALSE
knitr::include_graphics(here("results","figure2.png"))
```

@figure3 shows HSI and Gender

```{r}
#| label: figure3
#| fig-cap: "HSI and Gender."
#| echo: FALSE
knitr::include_graphics(here("results","figure3_HSI and Gender.png"))
```

@figure4 shows HSI and quit attempt
```{r}
#| label: figure4
#| fig-cap: "HSI and quit attempt."
#| echo: FALSE
knitr::include_graphics(here("results","figure4_HSI and Quit attempt.png"))
```

@figure5 shows HSI and quit attempt
```{r}
#| label: figure5
#| fig-cap: "HSI and quit attempt."
#| echo: FALSE
knitr::include_graphics(here("results","figure5_HSI and Education.png"))
```

  
## Basic statistical analysis

#Over here, I couldnt figure out how to graph the model results. The model resutsl table are under the results folder. I do realize my model fits need quite some work but I welcome your comments and suggestions. I particulary wanted to use the tidymodels for Ordinal Regression Model.    
